...
driver.find_element_by_css_selector(
    'body > div:nth-child(22) > div > div > div.styles__ButtonContainer-sc-1edagdx-2.ghJraX.sc-bwzfXH.hKiLMS.sc-bdVaJa.gMYdSF').click()
sleep(2)
...
driver.find_element_by_xpath(
    '//button[text()="Proceed to Checkout - $"]').click()
sleep(2)
# Checkout as guest
...
# choosing Credit
choosing_cash_box_xpath = '//[@id="top-scroll-container"]/div[2]/div/div[1]/div[1]/div[4]/div[2]/div/div[1]/label[1]/span'
